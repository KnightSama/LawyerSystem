...
public class EditCaseAction extends ActionSupport {
	...
	public String execute(){
		if(buttonName.equals("save"))
		{
			...
			casebeginService.update(casebegin);
			casefeeService.update(casefee);
			caseendsService.update(caseends);
			caseprocessingService.update(caseprocessing);
			filelendService.update(filelend);
			session = ActionContext.getContext().getSession();
			logtabService.addLog(session.get("username").toString(), "修改了案件编号为["+caseID+"]的信息", "成功");
