...
<script>
	function changePage(obj) {
		...
		document.forms.form2.action = "showlog";
	...
	function deleteV(obj) {
		...
		$parent('body').alert({
			...
			buttons : [ {
				...
				callback : function() {
					document.getElementById("checkbutton").value = obj.id;
					document.forms.form2.action = "deletelog";
					document.forms.form2.submit();
				}
			}, {
				id : 'no',
...
<body>
	...
	<div class="alert alert-info">
		当前位置<b class="tip"></b>系统管理<b class="tip"></b>查看日志
	</div>
	<table class="table table-striped table-bordered table-condensed">
		<form id="form1" action="findlog" method="post">
			<thead>
				<tr>
			...
			<tbody>
				...
				<tr>
					<td colspan="6" align="right"><input class="btn btn-inverse"
						...
						class="btn btn-inverse" id="clear" type="button" value="清空" /></td>
				</tr>
			</tbody>
		</form>
	</table>
	...
	<table class="table table-striped table-bordered table-condensed"
		...
		<tbody>
			...
			<s:iterator id="resu" value="list">
				<tr>
					<td><s:property value="username" /> </a></td>
					<td><s:property value="operateTime" />
					</td>
					<td><s:property value="operate" />
					</td>
					<td><s:property value="others" />
					</td>
					<s:set name="stbtnm" value="id"></s:set>
