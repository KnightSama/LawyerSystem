...
<script type="text/javascript">
	...
	function actionV(obj) {
			...
			document.forms.form.action = "editcase";
...
<body>
	<div class="alert alert-info">
		当前位置<b class="tip"></b>案件管理<b class="tip"></b>案件编辑
	</div>
					...
					<tbody>
							...
							<td>
								<div class="input-append">
									<input size="16" class="span2 datepicker" type="text"
										name="CaseStartTime" id="CaseStartTime"
										value="${caseStartTime}" /><span class="add-on"><i
							...
							<td>
								<div class="input-append">
									<input class="span2 datepicker" size="16" type="text"
										name="CaseHandleTime" id="CaseHandleTime"
										value="${caseHandleTime}" /><span class="add-on"><i
										class="icon-calendar"></i> </span>
							</td>
							</div>
						...
						<tr>
							...
							<td width="500" colspan="3" height=""><textarea
									...
									cols="5">${caseReason}</textarea></td>
						</tr>
						<tr>
							<td width="15%">原告</td>
							<td width="500" colspan="3" height=""><textarea
									name="Indicter" id="Indicter" style="width: 95%" rows="1"
									cols="5">${indicter}</textarea></td>
						</tr>
						<tr>
							<td width="15%">被告</td>
							<td width="500" colspan="3" height=""><textarea
									name="Indictee" id="Indictee" style="width: 95%" rows="1"
									cols="5">${indictee}</textarea></td>
						</tr>
						<tr>
							<td width="15%">第三人</td>
							<td width="500" colspan="3" height=""><textarea
									name="ThirdParty" id="ThirdParty" style="width: 95%" rows="1"
									cols="5">${thirdParty}</textarea></td>
						</tr>
						<tr>
							<td width="15%">诉讼请求</td>
							<td width="500" colspan="3" height=""><textarea
									name="suitRequest" id="suitRequest" style="width: 95%" rows="4"
									cols="5">${suitRequest}</textarea></td>
						</tr>
						<tr>
							<td>诉讼标的</td>
							<td><input name="suitValue" id="suitValue"
								value="${suitValue}" type="text" /></td>
							<td>诉讼费</td>
							<td>
								<div class="input-append">
						...
						<tr>
							...
							<td width="500" colspan="3" height=""><textarea
									...
									style="width: 95%" rows="4" cols="5"
									value="${belongingsMaintain}"></textarea></td>
						</tr>
						<tr>
							<td width="15%">证据保全</td>
							<td width="500" colspan="3" height=""><textarea
							...
							<td width="500" colspan="3" height="">
								<div class="input-append">
									<input class="span2" id="MaintainCost" name="MaintainCost"
										size="16" type="text" value="${maintainCost}" onchange="changeValue()" /><span
										class="add-on" >￥</span>
								</div></td>
						</tr>
					</tbody>
				...
				<table
					...
					<tbody>
							...
							<td>
								<div class="input-append">
									<input class="span2 datepicker" type="text" id="bullentinTime"
										name="bullentinTime" value="${bullentinTime}" /><span
							...
							<td>
								<div class="input-append">
									<input class="span2 datepicker" type="text" id="sittingTime"
										name="sittingTime" value="${sittingTime}" /><span
										class="add-on"><i class="icon-calendar"></i> </span>
							</td>
							</div>
							<td>独任审理</td>
						...
						<tr>
							<td width="15%">合议审理</td>
							<td width="500" colspan="3" height=""><textarea
									name="joinInquisition" style="width: 95%" rows="4" cols="5">${joinInquisition}</textarea>
							</td>
						</tr>
						<tr>
							<td>申请延期时间</td>
						...
						<tr>
							...
							<td>
								<div class="input-append">
									<input class="span2 datepicker" size="16" type="text"
										name="adjDeanTime" value="${adjDeanTime}" /><span
										class="add-on"><i class="icon-calendar"></i> </span>
							</td>
							</div>
							</td>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<div class="input-append">
									<input class="span2 datepicker" size="16" type="text"
										name="effectTime" value="${effectTime}" /><span
										class="add-on"><i class="icon-calendar"></i> </span>
							</td>
							</div>
							</td>
							...
							<td><input name="executeApplication" type="radio" value="是 " />
								是 <input type="radio" name="executeApplication" value="否" /> 否</td>
						</tr>
						<tr>
							<td>结案方式</td>
							<td colspan="3"><input name="kindOfEndACase" type="radio"
								value="判决" /> 判决 <input type="radio" name="kindOfEndACase"
								value="调解" /> 调解 <input name="kindOfEndACase" type="radio"
								value="撤诉 " /> 撤诉 <input name="kindOfEndACase" type="radio"
								value="移送" />移送</td>
						</tr>
						<tr>
							<td>结案时间</td>
							<td>
								<div class="input-append">
									<input class="span2 datepicker" size="16" type="text"
										name="caseEndTime" value="${caseEndTime}" /><span
										class="add-on"><i class="icon-calendar"></i> </span>
							</td>
							</div>
							</td>
							...
							<td>
								<div class="input-append">
									<input class="span2 datepicker" size="16" type="text"
										name="reportTime" value="${reportTime}" /><span
										class="add-on"><i class="icon-calendar"></i> </span>
							</td>
							</div>
							</td>
				...
				<table
					...
					<tbody>
						<tr>
							<td width="15%">借卷单位</td>
							<td width="500" colspan="3" height=""><textarea
									name="lendTo" style="width: 95%" rows="1" cols="5">${lendTo}</textarea>
							</td>
						</tr>
						<tr>
							<td width="15%">借卷联系人</td>
							<td width="500" colspan="3" height=""><textarea
									name="cManOfLend" style="width: 95%" rows="1" cols="5">${cManOfLend}</textarea>
							</td>
						</tr>
						<tr>
							<td width="15%">借卷原因</td>
							<td width="500" colspan="3" height=""><textarea
									name="lendFileReason" style="width: 95%" rows="4" cols="5">${lendFileReason}</textarea>
							</td>
						</tr>
						<tr>
							<td>借卷时间</td>
							<td>
								<div class="input-append">
									<input class="span2 datepicker" size="16" type="text"
										name="lendFileTime" value="${lendFileTime}" /><span
										class="add-on"><i class="icon-calendar"></i> </span>
							</td>
							</div>
							</td>
						...
						<tr>
							<td width="15%">移送单位</td>
							<td width="500" colspan="3" height=""><textarea
									name="moveTo" style="width: 95%" rows="2" cols="5">${moveTo}</textarea>
							</td>
						</tr>
						<tr>
							<td width="15%">移送原因</td>
							<td width="500" colspan="3" height=""><textarea
									name="moveReason" style="width: 95%" rows="4" cols="5">${moveReason}</textarea>
							</td>
						</tr>
						<tr>
							<td width="15%">备注</td>
							<td width="500" colspan="3" height=""><textarea
									name="moveMemo" style="width: 95%" rows="4" cols="5">${moveMemo}</textarea>
							</td>
						</tr>
						<tr>
							<td>移送时间</td>
	...
	<div style="text-align:center; ">
		<input class="btn btn-inverse" id="save" type="button"
			...
			type="hidden" id="checkbutton" name="buttonName"> 
	</div>
	</form>
</body>
</html>
