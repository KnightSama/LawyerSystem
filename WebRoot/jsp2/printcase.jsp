...
<script type="text/javascript">
	...
	function printV(obj) {
	    document.getElementById("does").value = obj.id;
		document.forms.form1.action = "jumpprintcase";
...
<body>
	<div class="alert alert-info">
		当前位置<b class="tip"></b>报表<b class="tip"></b>案件报表
	</div>

	<table class="table table-striped table-bordered table-condensed list">
		<thead>
			<tr>
				<td colspan="6">立案 <i class="tip-up"></i></td>
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			<tr>
				...
				<td>
					...
					<td>结案时间</td>
					<td>
						<div class="input-append">${caseHandleTime}</div></td>
			</tr>
			<tr>
				<td width="15%">案由</td>
	...
	<div style="text-align:center; ">
		<input class="btn btn-success" id="casebegin" type="button"
			onclick='printV(this)' value="浏览打印案件开始单" />
	</div>
	<br />
	<table class="table table-striped table-bordered table-condensed list">
		<thead>
			<tr>
				<td colspan="6">审理 <i class="tip-up"></i></td>
			</tr>
		</thead>
		<tbody>
			<tr>
	...
	<br />
	<div style="text-align:center; ">
		<input class="btn btn-success" id="caseprocessing" type="button"
			onclick='printV(this)' value="浏览打印案件处理单" />
	</div>
	<br />
	<table class="table table-striped table-bordered table-condensed list">
		<thead>
			<tr>
				<td colspan="6">结案 <i class="tip-up"></i></td>
			</tr>
		</thead>
		<tbody>
			<tr>
	...
	<br />
	<div style="text-align:center; ">
		<input class="btn btn-success" id="caseends" type="button"
			onclick='printV(this)' value="浏览打印案件结束单" />
	</div>
	<br />
	<table class="table table-striped table-bordered table-condensed list">
		<thead>
			<tr>
				<td colspan="6">卷宗<i class="tip-up"></i></td>
			</tr>
		</thead>
		<tbody>
			<tr>
	...
	<br />
	<div style="text-align:center; ">
		<input class="btn btn-success" id="filelend" type="button"
			onclick='printV(this)' value="浏览打印案件卷宗借阅单" />
	</div>
	<br />
	<table class="table table-striped table-bordered table-condensed list">
		<thead>
			<tr>
				<td colspan="6">费用 <i class="tip-up"></i></td>
			</tr>
		</thead>
		<tbody>
			<tr>
	...
	<br />
	<div style="text-align:center; ">
		<input class="btn btn-success" id="casefee" type="button"
			onclick='printV(this)' value="浏览打印案件收费单" />
	</div>
	<br />
	...
	<form id="form1" method="post" target="_blank">
		<div style="text-align:center; ">
			<input class="btn btn-inverse" id="cancel" type="button"
				onclick='backV(this)' value="返回" /> <input type="hidden"
				id="checkbutton" name="buttonName" value="${caseID}"><input
				type="hidden" id="topage" name="topage" value="${topage}"><input
					type="hidden" id="showMany" name="showMany" value="${showMany}">
						<input type="hidden" id="does" name="does">
		</div>
	</form>
	<form id="form" method="post">
		<input type="hidden" id="checkbutton" name="buttonName"
			value="${caseID}"><input type="hidden" id="topage"
			name="topage" value="${topage}"><input type="hidden"
				id="showMany" name="showMany" value="${showMany}">
	</form>
</body>
</html>
